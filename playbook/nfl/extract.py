...
def espn_nfl_team_roster():
    df_espn_nfl_sql = playbook.nfl.load.sqlite_query_table('nfl_extract_teams')
    ...
    df_nfl_data = df_nfl_data.astype(str)
    playbook.nfl.load.insert_data_to_sqlite_replace('nfl_extract_team_roster', df_nfl_data)
...
def espn_nfl_athletes():
    ...
    playbook.nfl.load.insert_data_to_sqlite_replace('nfl_extract_athletes', df_nfl_data)
...
def espn_nfl_athlete_stats():
    df_espn_nfl_athletes_sql = playbook.nfl.load.sqlite_query_table('nfl_extract_athletes')
    ...
    playbook.nfl.load.insert_data_to_sqlite('nfl_extract_athlete_stats', df_nfl_data)


def espn_nfl_team_roster_stats():
    df_espn_nfl_sql = playbook.nfl.load.sqlite_query_table('nfl_extract_team_roster')
