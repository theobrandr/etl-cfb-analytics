...
app.layout = html.Div([
    ...
    html.Div([
        dcc.Graph(id='offense-pass-success-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"}),
        dcc.Graph(id='offense-rush-success-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"})
    ], style={'display': 'flex', 'justify-content': 'space-between'}),
    html.Div([
        dcc.Graph(id='defense-pass-success-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"}),
        dcc.Graph(id='defense-rush-success-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"})
    ], style={'display': 'flex', 'justify-content': 'space-between'}),
    html.Div([
        dcc.Graph(id='offense-successRate-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"}),
        dcc.Graph(id='defense-successRate-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"})
    ], style={'display': 'flex', 'justify-content': 'space-between'}),
    html.Div([
    ...
    html.Div([
        dcc.Graph(id='specialteams-zscore-line', style={'display': 'inline-block', 'width': '49%', "margin-bottom": "5px"}),
...
def generate_visualization_figures(matchup):
    ...
    fig_matchup_current_season_table = vis_matchup_current_season_table(df_matchup_home_away_all_data, season, team_colors)
...
def vis_matchup_player_stats_table(df, stat_type, season_roster, team_colors, player_stat_title):
    ...
    team_colors_rgba = {team: hex_to_rgba(color) for team, color in team_colors.items()}
    cell_colors = [team_colors_rgba.get(team, 'rgba(255, 255, 255, 0.4)') for team in player_data_pos_stat['team_roster']]
